...
|                          |                                 | :black_square_button: it adds the order to the account of the customer after finishing the order                                      |
...
| `product-page.spec.js`     | Product page tests              | :heavy_check_mark: it can display the titel, description and image of the product correctly                                           |
|                          |                                 | :heavy_check_mark: it shows the correct price                                                                                         |
...
|                          |                                 | :heavy_check_mark: it cannot add the product to the cart if it is a configurable product and no options are selected                  |
...
|                          |                                 | :heavy_check_mark: it cannot add the product to the cart when the product is out of stock                                             |
...
The easiest way to install the tests is to clone this repository and move the `cypress` folder into your project. As of right now, we do not provide a fallback mechanism for customizations to the tests. 
