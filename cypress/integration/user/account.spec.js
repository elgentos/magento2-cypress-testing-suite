...
describe('Account activities', () => {
    ...
    it('Can edit the wishlist and remove item', () => {
        ...
        cy.get(selectors.wishlistQtyField).first().then(($qty) => {
    ...
    it('Can log out', () => {
        ...
        cy.get(selectors.signedOutHeader).should('contain.text', 'You have signed out')
    })
})
...
describe('Guest user test', () => {
    ...
    it('Can login from checkout', () => {
        ...
        cy.get(checkoutSelectors.checkoutPasswordLabel).click().type(account.customer.password)
        ...
        cy.get(checkoutSelectors.checkoutLoggedInEmail).should('contain.text', account.customer.customer.email)
